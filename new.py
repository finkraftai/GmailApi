...
def main():
    ...
    filters_label_id = get_label_id(service, user_id, "nine")
    if not filters_label_id:
        filters_label_id = create_label(service, user_id, "nine")
    ...
    try:
        ...
        with open("emails.csv", "w", newline="", encoding="utf-8") as csvfile:
            fieldnames = ["From", "To", "Subject", "Time", "noofattachments"]
            ...
            for message in messages:
                ...
                writer.writerow({"From": from_email, "To": to_email, "Subject": subject, "Time": time, "noofattachments": attachment_count})
